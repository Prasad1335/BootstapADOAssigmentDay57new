<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DeleteEmp2.aspx.cs" Inherits="BootstapADOAssigmentDay57.DeleteEmp2" %>
                            ...
                            <div class="col-12 col-lg-10 ">
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <asp:TextBox ID="TextBoxDoj"  CssClass="form-control in" runat="server"></asp:TextBox>
                                    </div>
                                    <div class="col-md-3">
                                    ...
                                    <div class="col-md-3"></div>
                                    <div class="col-md-3">
                                        <asp:Button CssClass="btn" ID="Button2" runat="server" Text="Submit Deatils" OnClick="ButtonDelete_OnClick" />
                                    </div>
                                </div>
