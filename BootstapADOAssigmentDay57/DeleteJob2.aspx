<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DeleteJob2.aspx.cs" Inherits="BootstapADOAssigmentDay57.DeleteJob2" %>
                            ...
                            <div class="col-md-10 ">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <h4 class="p-3 text-info  bg-dark mt-4 ">Delete Job Deatils</h4>
                                    </div>
                                     ...
                                     <div class="col-md-6">
                                         <div class="row">
                                            ...
                                            <asp:TextBox ID="TextBoxexpectedSalaryRange" CssClass="form-control in" placeholder="enter expected salary range" runat="server"></asp:TextBox>
                                              ...
                                              <div class="col-md-6">
                                                   <asp:Button CssClass="btn" ID="Button" runat="server" Text="Submit Deatils" OnClick="ButtonDelete_OnClick" />
                                              </div>
